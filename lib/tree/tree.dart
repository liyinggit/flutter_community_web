...
import 'package:flutter_community_web/tree/ImageText.dart';
import 'package:flutter_community_web/tree/SearchBar.dart';
import 'package:flutter_community_web/tree/node.dart';
        ...
        widgets.add(GestureDetector(
          child: ImageText(
            node.type == Node.typeOrgan
                ? node.expand ? Icons.expand_more : Icons.arrow_right
                : Icons.business,
            node.type == Node.typeOrgan
